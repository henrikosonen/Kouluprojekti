    ...
    public partial class mig1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryGroups", x => new { x.GroupId, x.CategoryId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryId = table.Column<int>(nullable: false),
                    Deleted = table.Column<DateTime>(nullable: true),
                    ResponseOptionsId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Assessments_ResponseOptions_ResponseOptionsId",
                        column: x => x.ResponseOptionsId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "c8d1ae41-5da6-4575-9d78-ecbc14f0fcae", "9413ce25-e09d-4c3a-9107-41d7a067cc22", "Opettaja", "OPETTAJA" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "c1428f07-21be-401d-a75f-ea4b5bca5548", "4a461d6a-c2b4-491e-abe3-623c5f97e6f6", "Opiskelija", "OPISKELIJA" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assessments_ResponseOptionsId",
                table: "Assessments",
                column: "ResponseOptionsId");
